...
<body>
					...
					<form name="editUser" action="updateUser">
						...
						<div class="input-group">
							<label for="email">Nome</label> <input type="text" id="nome"
								...
								value="<%=request.getAttribute("nome")%>" required>
						</div>
						<div class="input-group">
							<label for="senha">Senha</label> <input type="password"
								name="senha1" id="senha" placeholder="Digite sua senha" required>
						</div>
						<div class="input-group">
	...
	out.print("checked");%>><span>admin</span>
						</div>
						<input type="button" class="login-btn" value="Cadastrar"
							onclick="editarUsuario(<%=String.valueOf(request.getAttribute("id"))%>)">
					</form>
